...
// Split-D + M4N2 Flash Attention forward kernel (non-WS, CuTe TMA).
// Separate file to avoid touching the proven M8N1 kernels in fwd_sm120.cuh.
// Reuses all dependencies + TmaBarrier/CtaBarrier from fwd_sm120.cuh.
#include "fwd_sm120.cuh"

// 8 warps (4M×2N), kBr=64, 256 threads. O regs = D/4 per thread.
