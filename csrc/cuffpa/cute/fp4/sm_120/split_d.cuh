...
__global__ void __launch_bounds__(Traits::kNumThreads, 1)
    split_d_fwd_cute_fp4_sm120(CUTLASS_GRID_CONSTANT TmaQ const tma_q,
                               ...
                               ElementO* __restrict__ O,
                               float* __restrict__ softmax_lse,
                               const float* __restrict__ km,
                               const float* __restrict__ qm, int Nq, int Nkv,
                               int Nq_pad, int Nkv_pad, int Nh, int Nh_kv,
