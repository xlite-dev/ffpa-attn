...
void ffpa_attn_bwd_fp16f32(
  ...
  switch (d) {
    case 64: ffpa_attn_bwd_fp16f32_d64(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
    case 320: ffpa_attn_bwd_fp16f32_d320(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
    case 512: ffpa_attn_bwd_fp16f32_d512(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
...
void ffpa_attn_bwd_bf16f32(
  ...
  const int d = Q.size(3);
  switch (d) {
    case 64: ffpa_attn_bwd_bf16f32_d64(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
    case 320: ffpa_attn_bwd_bf16f32_d320(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
    case 512: ffpa_attn_bwd_bf16f32_d512(Q, K, V, O, softmax_lse, dO, dQ, dK, dV, stages, causal, softmax_scale); break;
    default: throw std::runtime_error("bwd: headdim not supported!");
  }
}
