...
void ffpa_attn_fwd_fp16f16_d544(
  ...
  if (stages == 2) {
    launch_ffpa_attn_fwd_template<__half, 544, kMmaAccFloat32QK, kMmaAccFloat32PV, 2>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else if (stages == 3) {
    launch_ffpa_attn_fwd_template<__half, 544, kMmaAccFloat32QK, kMmaAccFloat32PV, 3>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else if (stages == 4) {
