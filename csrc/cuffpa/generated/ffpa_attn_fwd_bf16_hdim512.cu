...
void ffpa_attn_fwd_bf16f32_d512(
  ...
  if (stages == 2) {
    launch_ffpa_attn_fwd_template<__nv_bfloat16, 512, kMmaAccFloat32QK, kMmaAccFloat32PV, 2>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else if (stages == 3) {
    ...
    launch_ffpa_attn_fwd_template<__nv_bfloat16, 512, kMmaAccFloat32QK, kMmaAccFloat32PV, 6>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else if (stages == 7) {
    launch_ffpa_attn_fwd_template<__nv_bfloat16, 512, kMmaAccFloat32QK, kMmaAccFloat32PV, 7>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else if (stages == 8) {
    launch_ffpa_attn_fwd_template<__nv_bfloat16, 512, kMmaAccFloat32QK, kMmaAccFloat32PV, 8>(Q, K, V, O, attn_bias, softmax_lse, causal, softmax_scale, dropout_p, philox_seed, philox_offset, tma);
  } else {
