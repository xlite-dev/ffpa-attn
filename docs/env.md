...
- <span style="color:#c77dff;">ENABLE_FFPA_ALL_HEADDIM</span>, default `False (0)`, When `1`, headdims range from `64` to `1024` with step `64` (`range(64, 1024, 64)`); when `0`, headdims range from `320` to `1024` with step `64` (`range(320, 1024, 64)`, i.e. multiples of 64 with headdim >= 320).
