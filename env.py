...
class ENV(object):
  ...
  def _decl(symbol: str, with_stages: bool) -> str:
    ...
    args += (
      ...
      "int64_t fp4_hybrid_n_early, bool fp4_hadamard, int64_t fp4_pv_mm_type"
    )
  ...
  def _render_wrapper_dispatch(cls, variant: str, d: int) -> str:
    ...
    call = (
      ...
      "fp4_hybrid, fp4_hybrid_n_early, fp4_hadamard, fp4_pv_mm_type"
    )
    if not branches:
  ...
  def _render_stage_tu(
    ...
    body.append(
      ...
      "fp8_hybrid_n_early, fp4_hybrid, fp4_hybrid_n_early, fp4_hadamard, fp4_pv_mm_type);"
    )
    return (
      "// AUTO-GENERATED by env.py. DO NOT EDIT.\n"
      '#include "launch.cuh"\n'
