...
class ENV(object):
  ...
  def _arg_lines(with_stages: bool) -> list:
    ...
    lines += [
      ...
      "    bool smooth_k,",
      "    bool smooth_v,",
      "    int64_t q_quant_method,",
      "    int64_t k_quant_method,",
      "    int64_t v_quant_method,",
      "    int64_t pv_acc_type,",
      "    int64_t qk_mm_type)",
    ]
    return lines
  ...
  def _decl(symbol: str, with_stages: bool) -> str:
    ...
    args += (
      ...
      "bool smooth_v, int64_t q_quant_method, int64_t k_quant_method, "
      "int64_t v_quant_method, int64_t pv_acc_type, int64_t qk_mm_type"
    )
  ...
  def _render_stage_tu(
    ...
    body.append(
      ...
      "smooth_v, q_quant_method, k_quant_method, v_quant_method, pv_acc_type, "
      "qk_mm_type);"
    )
    return (
      "// AUTO-GENERATED by env.py. DO NOT EDIT.\n"
    ...
    for name, dtype in specs:
      ...
      for d in headdims:
        out.append(
          ...
          "philox_offset, smooth_k, smooth_v, q_quant_method, k_quant_method, "
          "v_quant_method, pv_acc_type, qk_mm_type); break;"
        )
      out.append(
