    ...
    for name, dtype in specs:
      ...
      for d in headdims:
        out.append(
          ...
          "philox_offset, fp8_smooth_k, fp8_smooth_v, fp8_q_quant_method, "
          "fp8_k_quant_method, fp8_v_quant_method, fp8_pv_acc_type, "
          "fp8_qk_mm_type, fp8_hybrid, fp8_hybrid_n_early); break;"
        )
      out.append(
