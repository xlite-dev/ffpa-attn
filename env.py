...
| `m{m}` | `0..3` | `kModeL`: bias tile mode - 0 = gmem-direct fallback (no TMA), 1 = dense [kBr,kBc] TMA tile, 2 = row-broadcast TMA ([1,Nkv]), 3 = resident row vector in smem |
| `f{f}` | `0` / `1` | `kB4`: bias element width - 1 = 4 bytes (fp32), 0 = 2 bytes (fp16/bf16) |
...
"""
  ...
  def _render_fp8_variants_header(cls, headdims, dtypes) -> str:
    """Shared fp8 variant header: extern declarations everywhere.

    The variant TUs (fwd_*_cute_fp8_*_v*.cu) define FFPA_FP8_VARIANTS_TU
    before including this header and get nothing but the definition
    chain (dispatch/cute_fp8.cuh -> launch/cute_fp8.cuh), so each TU
    compiles exactly one kernel table. Every family TU includes this
    header without the define and gets extern-template declarations for
  ...
  def _render_fp8_variant_tu(
    ...
    return (
      "// AUTO-GENERATED by env.py. DO NOT EDIT.\n"
      "#define FFPA_FP8_VARIANTS_TU\n"
      '#include "generated/fwd_cute_fp8_variants.cuh"\n\n'
  ...
  def _fp4_impl_variants(cls, d: int):
    ...
    FFPA_BIAS_TILE_KEEP. Tag tuple = (kPvMxfp8, kBiasOn, kModeL, kB4).
    """
  ...
  def _render_fp4_variants_header(cls, headdims, dtypes) -> str:
    """Shared fp4 variant header: extern declarations everywhere.

    Same dual-mode contract as the fp8 table (see
    _render_fp8_variants_header): variant TUs define FFPA_FP4_VARIANTS_TU
    and compile exactly one kernel table via dispatch/cute_fp4.cuh; every
    family TU includes this header without the define and gets
    extern-template declarations that suppress variant re-instantiation.
    """
    decls = []
  ...
  def _render_fp4_variant_tu(
    ...
    return (
      "// AUTO-GENERATED by env.py. DO NOT EDIT.\n"
      "#define FFPA_FP4_VARIANTS_TU\n"
      '#include "generated/fwd_cute_fp4_variants.cuh"\n\n'
