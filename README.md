...
- [2026-08] 🚀 Add [**FFPA FP8/FP4**](#end-to-end-inference) benchmark results (compare with **Sage-2/3**) for NVIDIA RTX [5090](#end-to-end-inference), [PRO 5000 and 6000](#end-to-end-inference), achieving significant speedup for FP4 Attention (~[**1000 TOPS**](#end-to-end-inference) for D=128 on PRO 6000). 🎉🎉
