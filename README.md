...
Runnable examples are provided under [`examples`](./examples). The performance benchmark for the NVIDIA L20 (Ada), NVIDIA Geforce RTX 5090 (Blackwell), NVIDIA H800 PCIE (Hopper), NVIDIA H200 (Hopper, **CuTeDSL** backend, up to **427** TFLOPS!🎉) with large headdim are shown below:
