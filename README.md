...
- [2026-08] 🚪 FFPA now experimental supports [**FP4 Attention**](./csrc/cuffpa/cute/fp4/) for headdims **[64,1024]** ([sm_120](./csrc/cuffpa/cute/fp4/sm_120/), forward only), achieving **910**🎉 TFLOPS for D=128 on NVIDIA RTX 5090, the performance of large headdims is stay tuned for future updates. 🎉🎉
