...
- [2026/07/31] FFPA now supports [**FP8 Attention**](./csrc/cuffpa/cute/fp8/) for headdims **[64,1024]** ([sm_120](./csrc/cuffpa/cute/fp8/sm_120/), forward only) and achieving **3x~6x**🎉 speedup over standard PyTorch SDPA for large headdim (**D>256**), w/ per-block/thread/channel quantization and hybrid FP8/FP16 attention. 🎉🎉
