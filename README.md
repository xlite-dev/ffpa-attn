...
To improve performance, it would require a major redesign (**super-tiled Q/K/V on TMA** + **warp-specialized** producer/consumer with WGMMA instructions), rather than a drop-in K/V replacement.
