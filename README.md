...
- [2026-09] 🎯 FFPA now supports **attn_mask** for [**FP8/FP4 Attention**](#end-to-end-inference), achieving **4.4x~4.9x** speedup over standard PyTorch SDPA (BF16) for D=64/128 on NVIDIA RTX PRO 5000. Stay tuned for future updates. 🎉🎉
- [2026-08] 🚀 Add [**FFPA FP8/FP4**](#end-to-end-inference) benchmark results (compare with **Sage-2/3**) for NVIDIA RTX [5090](#end-to-end-inference), PRO [5000, 6000](#end-to-end-inference), achieving significant speedup for FP4 Attention (~[**1000 TOPS**](#end-to-end-inference) for D=128 on PRO 6000). 🎉🎉
