...
def get_build_sources():
    build_sources = []
    build_sources.append(f'{project_dir}/csrc/cuda/faster_prefill_attn_F16F16F16F16_L1.cu')
    build_sources.append(f'{project_dir}/csrc/cuda/faster_prefill_attn_F32F16F16F32_L1.cu')
