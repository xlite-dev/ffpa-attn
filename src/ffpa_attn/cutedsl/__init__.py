...
:mod:`ffpa_attn.ffpa_attn_interface`, and triggers the side-effectful import
of :mod:`._interface` so the ``ffpa_attn::splitd_fwd_sm90`` /
``splitd_bwd_sm90`` ``torch.library`` ops (used by
