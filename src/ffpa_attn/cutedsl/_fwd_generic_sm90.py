...
The generic dense path reuses that SplitD pipeline with a fixed 512-wide
physical tile while the public tensors keep their logical head dimension. TMA
OOB handling zero-fills padded loads and drops padded stores for D < 512.
"""
