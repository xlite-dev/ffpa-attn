...
from . import elem_pointer, predicate_k, shuffle_sync
...
class PackGQA:
  ...
  # Reserved for future SM90 (Hopper) forward extension: non-TMA Q load path.
  @cute.jit
  def load_Q(
    self,
  ...
  # Reserved for future SM90 (Hopper) forward extension: non-TMA O store path.
  @cute.jit
  def store_O(
    self,
